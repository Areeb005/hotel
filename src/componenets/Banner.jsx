...
export default function Banner() {
  ...
  var countDownDate = new Date(`${monthName[currentMonth]} ${lastDay}, ${currentYear} 15:37:25`).getTime();
        ...
        <div className="main1">
          <div className="submain1">
            <div className="heading">
              <h1>CrytoNexa Cryptocurrency <br /> Pre-ICO starts in:</h1>
            </div>
